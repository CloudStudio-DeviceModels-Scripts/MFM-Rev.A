...
# Parsing + Configuration Script – MFM - Rev. A

This **Parsing + Configuration** script is designed for the **MFM** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – MFM Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **MFM** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
